  ...
  HttpClient createHttpClient(SecurityContext? context) {
    ...
    return super.createHttpClient(context)
      ..badCertificateCallback = (X509Certificate cert, String host, int port) {
        ...
        bool selfSignedCertsAllowed = Store.I.get(
          AppSettingsEnum.allowSelfSignedSSLCert.storeKey,
          AppSettingsEnum.allowSelfSignedSSLCert.defaultValue,
        );

        bool isLoggedIn = Store.I.tryGet(StoreKey.currentUser) != null;
        ...
        if (isLoggedIn && selfSignedCertsAllowed) {
          String serverHost =
              Uri.parse(Store.I.tryGet(StoreKey.serverEndpoint) ?? "").host;
